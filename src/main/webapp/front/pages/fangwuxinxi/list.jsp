          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="name" id="fwname" placeholder="民宿名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('fangwuxinxi','新增')" @click="jump('../fangwuxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../fangwuxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#fangwuxinximingcheng').val()) {
          param['fwname'] = jquery('#fwname').val() ? '%' + jquery('#fwname').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('fangwuxinxi/page', 'get', param, function(res) {
