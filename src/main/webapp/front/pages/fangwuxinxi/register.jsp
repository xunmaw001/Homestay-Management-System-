      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="yaopinmingcheng" name="yaopinmingcheng" placeholder="请输入民宿名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="changjia" name="changjia" placeholder="请输入厂家" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
