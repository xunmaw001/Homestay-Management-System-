                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>民宿名称 Search</label>

                                        <input id="fwname" name="fwname" class="form-control"
                                               v-model="ruleForm.fwname" readonly>
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        民宿类型 Search
                                        <input id="fwlxTypesSelect" name="fwlxTypesSelect" class="form-control"
                                        // v-model="ruleForm.fwlxTypes" readonly
                                        >
                                    </label>
                                </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <label>
                                        民宿状态 Search
                                        <input id="fwstateTypesSelect" name="fwstateTypesSelect" class="form-control"
                                        // v-model="ruleForm.fwstateTypes" readonly
                                        >
                                    </label>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        所属房东
                                        <input id="fdTypesSelect" name="fdTypesSelect" class="form-control"
                                        // v-model="ruleForm.fdTypes" readonly
                                        >
                                    </label>
                                </div>
                                    <div class="form-group col-md-6">
...
<script>
    ...
    //查询当前页面下所有列表
        function fwlxTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=fwlx_types", "GET", {}, (res) => {
                if(res.code == 0){
        ...
        function fdTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=fd_types", "GET", {}, (res) => {
                if(res.code == 0){
    ...
    function setSelectOption() {
        for (var i = 0; i < fwlxTypesOptions.length; i++) {
            if(fwlxTypesOptions[i].codeIndex == ruleForm.fwlxTypes){//下拉框value对比,如果一致就赋值汉字
                var fwlxTypesSelect = document.getElementById("fwlxTypesSelect");
                    fwlxTypesSelect.value = fwlxTypesOptions[i].indexName;
            }
        }
        for (var i = 0; i < fwstateTypesOptions.length; i++) {
            if(fwstateTypesOptions[i].codeIndex == ruleForm.fwstateTypes){//下拉框value对比,如果一致就赋值汉字
                var fwstateTypesSelect = document.getElementById("fwstateTypesSelect");
                    fwstateTypesSelect.value = fwstateTypesOptions[i].indexName;
            }
        }
        for (var i = 0; i < fdTypesOptions.length; i++) {
            if(fdTypesOptions[i].codeIndex == ruleForm.fdTypes){//下拉框value对比,如果一致就赋值汉字
                var fdTypesSelect = document.getElementById("fdTypesSelect");
                    fdTypesSelect.value = fdTypesOptions[i].indexName;
            }
        }
    }
