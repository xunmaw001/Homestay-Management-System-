                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>民宿名称</label>
                                        <input id="fwname" name="fwname" class="form-control"
                                               placeholder="民宿名称">
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>民宿类型</label>
                                       <select id="fwlxTypesSelect" name="fwlxTypes" class="form-control">
                                       </select>
                                   </div>
                                 <div class="form-group col-md-6">
                                     <label>价格（天）</label>
                                     <input id="money" name="money" class="form-control"
                                            onchange="moneyChickValue(this)" placeholder="价格（天）">
                                 </div>
                                   <div class="form-group col-md-6">
                                       <label>民宿图片</label>
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>民宿状态</label>
                                       <select id="fwstateTypesSelect" name="fwstateTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>所属房东</label>
                                       <select id="fdTypesSelect" name="fdTypes" class="form-control">
                                       </select>
                                   </div>
                                    <div class="form-group col-md-6">
                                        <label>房东联系电话</label>
...
<script>
    ...
    //初始化下拉框
    function initializationFwlxtypesSelect(){
        var fwlxTypesSelect = document.getElementById('fwlxTypesSelect');
            for (var i = 0; i < fwlxTypesOptions.length; i++) {
                fwlxTypesSelect.add(new Option(fwlxTypesOptions[i].fwname,fwlxTypesOptions[i].id));
            }
    }
    ...
    function initializationFdtypesSelect(){
        var fdTypesSelect = document.getElementById('fdTypesSelect');
            for (var i = 0; i < fdTypesOptions.length; i++) {
                fdTypesSelect.add(new Option(fdTypesOptions[i].name,fdTypesOptions[i].id));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        for (var i = 0; i < fwlxTypesOptions.length; i++) {
            if(fwlxTypesOptions[i].id == ruleForm.fwlxTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("fwlxTypesSelect").options[i].selected = true;
            }
        }
        for (var i = 0; i < fwstateTypesOptions.length; i++) {
            if(fwstateTypesOptions[i].codeIndex == ruleForm.fwstateTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("fwstateTypesSelect").options[i].selected = true;
            }
        }
        for (var i = 0; i < fdTypesOptions.length; i++) {
            if(fdTypesOptions[i].id == ruleForm.fdTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("fdTypesSelect").options[i].selected = true;
            }
        }
    }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
        initializationFwlxtypesSelect();
        initializationFwstatetypesSelect();
        initializationFdtypesSelect();
        getDetails();
        //初始化上传按钮
        upload();
        //单列求和
